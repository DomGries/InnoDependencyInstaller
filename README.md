...
* .NET
    ...
    * .NET 5 (Runtime, ASP.NET, Desktop)
    * .NET 6 (Runtime, ASP.NET, Desktop)
    * .NET 7 (Runtime, ASP.NET, Desktop)
    * .NET 8 (Runtime, ASP.NET, Desktop)
    * .NET 9 (Runtime, ASP.NET, Desktop)
    * .NET 10 (Runtime, ASP.NET, Desktop)
* C++
