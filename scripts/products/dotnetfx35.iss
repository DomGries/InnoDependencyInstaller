...
[Run]
Filename: "{ini:{tmp}{\}dep.ini,install,dotnetfx35}"; Description: "{cm:dotnetfx35_title}"; StatusMsg: "{cm:depinstall_status,{cm:dotnetfx35_title}}"; Parameters: "/lang:enu /qb /norestart"; Flags: skipifdoesntexist
...
begin
	...
	if IntToStr(version) <> '1' then
		AddProduct('dotnetfx35', 'dotnetfx35.exe', CustomMessage('dotnetfx35_title'), CustomMessage('dotnetfx35_size'), dotnetfx35_url);
end;
