...
[Run]
Filename: "{ini:{tmp}{\}dep.ini,install,mdac28}"; Description: "{cm:mdac28_title}"; StatusMsg: "{cm:depinstall_status,{cm:mdac28_title}}"; Parameters: "/q:a /c:""install /qb /l"""; Flags: skipifdoesntexist
...
begin
	...
	if (version < MinVersion) then
	   AddProduct('mdac28', 'mdac28.exe', CustomMessage('mdac28_title'), CustomMessage('mdac28_size'), mdac28_url);
end;